            ...
            <div class='header'></div>
                ...
                <StyledFormWrapper>
                    ...
                    <StyledForm>
                        ...
                        <StyledSelect type="text" name="role"/>

                        <StyledLabel htmlFor="staging">Staging</StyledLabel>
                        <StyledSelect type="text" name="staging"/>

                        <StyledFieldSet>
                            <legend>Load Variables</legend>
                            <StyledLabel htmlFor="database">Database</StyledLabel>
                            <StyledSelect type="text" name="database"/>
                            <StyledLabel htmlFor="warehouse">Warehouse</StyledLabel>
                            <StyledSelect type="text" name="warehouse"/>
                            <StyledLabel htmlFor="stage">Stage</StyledLabel>
                            <StyledInput type="text" name="stage"/>
                        </StyledFieldSet>
                </StyledForm>
                </StyledFormWrapper>
...
export default SnowflakeTarget;